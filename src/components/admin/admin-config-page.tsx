    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 xl:grid-cols-3">
        <Card className="border-border bg-card shadow-sm">
          <CardHeader>
            <CardTitle className="flex items-center gap-2"><ShieldCheck className="h-5 w-5 text-primary" /> Operador autenticado</CardTitle>
        ...
        <Card className="border-border bg-card shadow-sm">
          <CardHeader>
            <CardTitle className="flex items-center gap-2"><Shield className="h-5 w-5 text-primary" /> Segredos</CardTitle>
        ...
        <Card className="border-border bg-card shadow-sm">
          <CardHeader>
            <CardTitle className="flex items-center gap-2"><TerminalSquare className="h-5 w-5 text-primary" /> Seed inicial</CardTitle>
